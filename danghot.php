	...
	<?php
        ...
        echo '<div class="container-fluid">
                <div class= "row">
                  <div class="col-md-2">';
        if($theloai == 'Mới nhất')
          echo '<a href="danghot.php?page=1&theloai=Mới nhất" type="button" class="btn btn-success mt-2" style="width:100%">Mới nhất</a>
                ';
        else  
          echo '<a href="danghot.php?page=1&theloai=Mới nhất" type="button" class="btn btn-outline-success mt-2" style="width:100%">Mới nhất</a>
          ';
        
		if($theloai == 'Bán chạy nhất')
          echo '<a href="danghot.php?page=1&theloai=Bán chạy nhất" type="button" class="btn btn-success mt-2" style="width:100%">Bán chạy nhất</a>
                ';
        else  
          echo '<a href="danghot.php?page=1&theloai=Bán chạy nhất" type="button" class="btn btn-outline-success mt-2" style="width:100%">Bán chạy nhất</a>
          ';

		if($theloai == 'Giá tốt nhất')
          echo '<a href="danghot.php?page=1&theloai=Giá tốt nhất" type="button" class="btn btn-success mt-2" style="width:100%">Giá tốt nhất</a>
                ';
        else  
          echo '<a href="danghot.php?page=1&theloai=Giá tốt nhất" type="button" class="btn btn-outline-success mt-2" style="width:100%">Giá tốt nhất</a>
          ';
        ...
        echo'<div class="btn-toolbar mb-3">
                <div class="col-md-8"></div>
                    <div>';
        if($page == 1)
            echo '<a type="button" class="btn btn-outline-secondary disabled" href="danghot.php?page=' . $page-1 . '&theloai='. $theloai .'" style="width:100px" ><< Trước</a> ';
        else 
            echo '<a type="button" class="btn btn-outline-secondary" href="danghot.php?page=' . $page-1 .'&theloai='. $theloai .'" style="width:100px" ><< Trước</a> ';


        for($i=1;$i<=$dem;++$i) {
            if($page==$i)
                echo '<a type="button" class="btn btn-secondary" href="danghot.php?page='. $i .'&theloai='. $theloai .'">'. $i .'</a> ';
            else
                echo '<a type="button" class="btn btn-outline-secondary" href="danghot.php?page='. $i .'&theloai='. $theloai .'">'. $i .'</a> ';
        }
        if($page==$dem)
            echo '<a type="button" class="btn btn-outline-secondary disabled" href="danghot.php?page=' . $page+1 .'&theloai='. $theloai .'" style="width:100px">Sau >></a>';
        else 
        echo '<a type="button" class="btn btn-outline-secondary" href="danghot.php?page='. $page+1 .'&theloai='. $theloai .'" style="width:100px">Sau >></a>';   
        echo'
                </div>
            </div>';       
    ?>
