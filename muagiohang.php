...
<nav class="navbar navbar-expand-lg navbar-inverse bg-light">
    ...
    <?php
      ...
      echo '<h3 style="color:green">Tổng thanh toán: '. ($tongtien + 30000) . 'đ</h3>';
      echo '<hr  width="100%" size="5px" />';
      echo '</div>';
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-6">
          <form action="muathanhcong.php" method="post">
            ...
            <?php
              $id = isset($_GET['id']) ? $_GET['id'] : 'rong';
                echo
                '<div class="form-group">
                  <a href="giohang.php?id=0" class="btn btn-danger">Quay lại</a>
